...
## File logging in roku-debug

Adds file logging support to roku-debug to support writing logs to file for telnet/io output, and also debugger output

([#155](https://github.com/RokuCommunity/roku-debug/pull/155))

## @types/request in package.json

We moved @types/request to `dependencies` section in package.json to fix an issue in d.bs files 

([691a7be](https://github.com/RokuCommunity/roku-debug/commit/691a7be))
