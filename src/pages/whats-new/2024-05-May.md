...
## Fix bug that prevented accessing global in scenegraph inspector, prevent duplicate requests for same node
<!-- 2024-04-25 (for v2.48.2 released on 2024-05-17), https://github.com/RokuCommunity/vscode-brightscript-language/pull/565 -->




## Bump node version to 18
<!-- 2024-05-03 (for v2.48.2 released on 2024-05-17), https://github.com/RokuCommunity/vscode-brightscript-language/pull/566 -->

macos-latest doesn't work with node v14. Also, vscode runs NodeJS 18 so we should be using that for all our CI. This bumps the version to node18 for all the relevant scripts. 
...
Fix bugs in the brighterscript version picker:
 - prevent exception when `node_modules/brighterscript` cannot be found.
 - always store the `brightscript.bsdk` using forward slashes so it works cross-platform
 
![image](https://github.com/rokucommunity/vscode-brightscript-language/assets/2544493/ad3207a4-cb6d-4ca4-820d-6f2dcfb4acb3)



## Fix broken device view and Improve manual ip address component
<!-- 2024-05-20 (for v2.48.3 released on 2024-05-20), https://github.com/RokuCommunity/vscode-brightscript-language/pull/570 -->

Fixes broken device view.

Improves the manual IP address UI layout.
...
## fix node14
<!-- 2024-05-03 (for v0.21.8 released on 2024-05-16), https://github.com/RokuCommunity/roku-debug/pull/188 -->




## Fixing issues before release 0.21.8
<!-- 2024-05-16 (for v0.21.8 released on 2024-05-16), ([756824a](https://github.com/RokuCommunity/roku-debug/commit/756824a)) -->
...
<!-- 2024-03-19 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1116 -->
...
## Upgade LSP packages
<!-- 2024-03-20 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1117 -->

Upgade to latest versions of the language server packages.


## Plugin hook provide workspace symbol
<!-- 2024-03-21 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1118 -->
...
<!-- 2024-03-22 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1120 -->
...
<!-- 2024-04-17 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1137 -->

Upgrades the logger to use @rokucommunity/logger instead of the embedded one. 


## Removes diagnostic on accessing unknown member of roAssociativeArray
<!-- 2024-04-24 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1143 -->
...
<!-- 2024-05-09 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1169 -->
...
## Fix formatting with logger output
<!-- 2024-05-09 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1171 -->

Fix output formatting with the new logger updates so it matches what was in the previous logger.
...
<!-- 2024-05-16 (for v1.0.0-alpha.30 released on 2024-05-16), https://github.com/RokuCommunity/brighterscript/pull/1183 -->
...
~~Once brighterscript-Alpha30 is released, we'll need to update the package here~~
...
## brs
## Added to CLI: colorization and commands `help`, `clear` and `vars`
...
## Added support for bitwise NOT for numeric values
...
<!-- 2024-02-26 (for v4.0.0-alpha.1 released on 2024-05-17), https://github.com/RokuCommunity/roku-deploy/pull/145 -->
...
<!-- 2024-03-01 (for v4.0.0-alpha.1 released on 2024-05-17), https://github.com/RokuCommunity/roku-deploy/pull/136 -->
