...
We removed validation for properties on standard typed `roAssociativeArray` objects, as their entire point is to be a generic dictionary of anything.
